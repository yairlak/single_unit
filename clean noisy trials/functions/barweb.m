...
% 	ylim([0 ymax*1.1]);
	...
	if strcmp(legend_type, 'axis')
		for i = 1:numbars
			...
			for j = 1:length(xdata)
				text(xdata(j),  -0.03*ymax*1.1, bw_legend(i), 'Rotation', 60, 'fontsize', 20, 'HorizontalAlignment', 'right');
			end
		end
	...
	set(gca, 'xticklabel', groupnames, 'box', 'off', 'ticklength', [0 0], 'fontsize', 18, 'xtick',1:numgroups, 'linewidth', 2,'xgrid','off','ygrid','off', 'FontSize', 20);
